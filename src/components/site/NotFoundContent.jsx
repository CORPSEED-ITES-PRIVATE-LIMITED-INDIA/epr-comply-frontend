...
const NotFoundContent = () => (
  <section className="h-full bg-white flex items-center justify-center px-4">
    <div className="max-w-xl w-full text-center p-8 md:p-12 mt-4 md:mt-6 lg:mt-10">
      <div
        className="mx-auto mb-6 flex h-16 w-16 items-center justify-center rounded-full bg-green-400/40 text-green-600 text-3xl font-bold"
        aria-hidden="true"
      >
        !
      </div>
      ...
      <div className="mt-8 flex justify-center gap-4">
        <Link
          href="/"
          className="rounded-full bg-green-700 px-6 py-3 text-sm font-semibold text-white hover:bg-green-800 transition"
        >
          Go Home
        </Link>
